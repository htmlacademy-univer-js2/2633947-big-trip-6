// Файл: main.js
// Точка входа в приложение. Инициализирует модели, презентеры и запускает приложение.
...
// Генерация случайной строки для авторизации
...
// Обработчики для кнопки создания новой точки
...
// Кнопка создания новой точки изначально заблокирована до загрузки данных
document.querySelector('.trip-main__event-add-btn').disabled = true;
...
// Загрузка данных с сервера, после загрузки разблокируем кнопку
pointsModel.init()
  .finally(() => {
    document.querySelector('.trip-main__event-add-btn').disabled = false;
  });
